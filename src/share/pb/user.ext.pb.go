...
func (*RegistAccountReq) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*RegistAccountRsp) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*LoginAccountReq) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*LoginAccountRsp) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func (*ResetAccountReq) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4} }
...
func (*ResetAccountRsp) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{5} }
...
func (*WantScoreReq) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{6} }
...
func (*WantScoreRsp) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{7} }
...
func init() { proto.RegisterFile("user.ext.proto", fileDescriptor4) }
