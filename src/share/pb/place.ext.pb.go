...
func (*HotCitiesByCinemaReq) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*HotCitiesByCinemaRep) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func init() { proto.RegisterFile("place.ext.proto", fileDescriptor2) }
