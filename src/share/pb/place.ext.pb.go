...
func (*HotCitiesByCinemaReq) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*HotCitiesByCinemaRep) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*Place) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func init() { proto.RegisterFile("place.ext.proto", fileDescriptor1) }
